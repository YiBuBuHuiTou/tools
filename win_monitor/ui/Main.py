...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(705, 631))
        MainWindow.setMaximumSize(QtCore.QSize(705, 631))
        icon = QtGui.QIcon()
        ...
        self.office_config.setGeometry(QtCore.QRect(10, 10, 661, 541))
        ...
        self.attendance.setGeometry(QtCore.QRect(10, 469, 291, 71))
        self.attendance.setObjectName("attendance")
        self.layoutWidget = QtWidgets.QWidget(self.attendance)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 30, 232, 22))
        ...
        self.local_data = QtWidgets.QLineEdit(self.layoutWidget1)
...
"}")
        ...
        self.data_dir = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.online_config.setGeometry(QtCore.QRect(10, 130, 219, 211))
        self.online_config.setObjectName("online_config")
        self.layoutWidget2 = QtWidgets.QWidget(self.online_config)
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 22, 201, 170))
        ...
        self.db_host = QtWidgets.QLineEdit(self.layoutWidget2)
        ...
        self.db_name = QtWidgets.QLineEdit(self.layoutWidget2)
        self.db_name.setObjectName("db_name")
        self.gridLayout_2.addWidget(self.db_name, 3, 1, 1, 1)
        self.db_password = QtWidgets.QLineEdit(self.layoutWidget2)
        ...
        self.layoutWidget3 = QtWidgets.QWidget(self.data_store)
        self.layoutWidget3.setGeometry(QtCore.QRect(10, 22, 211, 18))
        ...
        self.offline = QtWidgets.QRadioButton(self.layoutWidget3)
        ...
        self.online = QtWidgets.QRadioButton(self.layoutWidget3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget4 = QtWidgets.QWidget(self.user_info)
        self.layoutWidget4.setGeometry(QtCore.QRect(10, 10, 177, 74))
...
"border-right-width:0px;")
        ...
        self.cycle = QtWidgets.QSpinBox(self.layoutWidget6)
        ...
        self.delay = QtWidgets.QSpinBox(self.layoutWidget6)
        ...
        self.layoutWidget7.setGeometry(QtCore.QRect(520, 560, 158, 25))
